    ...
    const load = async () => {
      ...
      const storedUid =
        typeof window !== "undefined"
          ...
          : null;
      let username = searchParams.get("username") || storedUsername || undefined;
  ...
  return (
    <>
      ...
      <nav className="navbar">
        ...
        <div className="nav-title">Collezione</div>
        <div style={{ width: 28 }} />
      </nav>
          ...
          filteredAchievements.map((ach) => (
            ...
            >
              <div className="card-header">
                ...
                >
                  {ach.hidden ? "Segreto" : ach.unlocked ? "Completato" : "In corso"}
                </div>
              </div>
              ...
              <p className="card-desc">
                {ach.hidden && !ach.unlocked
                  ...
                  : ach.description || "Nuovo badge aggiunto alla collezione."}
              </p>
              {ach.progress ? (
